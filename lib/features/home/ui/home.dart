...
import 'package:pyramid/features/goTo/ui/goTo.dart';
              ...
              child: Column(
                  ...
                  children: [
                      ...
                      child: Container(
                        ...
                        child: Stack(
                          children: [
                            Center(
                              child: Container(
                                  child: Image.network('https://hortonbarbell.com/wp-content/uploads/2022/06/Barbell-Reverse-Lunge.webp',fit: BoxFit.fill,)),
                            ),
                            Container(
                              decoration: BoxDecoration(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: Text('Best Quarantine',style: TextStyle(fontSize: 25,color: Colors.white,fontWeight: FontWeight.bold),),
                                  ),
                                ),
                                Padding(
                                  ...
                                  child: Container(
                                    alignment: Alignment.topLeft,
                                    child: Text('Workout',style: TextStyle(fontSize: 25,color: Colors.white,fontWeight: FontWeight.bold),),
                                  ),
                                ),
                                SizedBox(
                                  height: 80,
                                ...
                                InkWell(
                                  ...
                                  child: Container(
                                    ...
                                    child: Text('See more  >',style: TextStyle(fontSize: 10,color: Colors.limeAccent.shade400),),
                                  ),
                                ),
                              ],
                            ),
                    ...
                    Container(
                        ...
                        child: Text('Best for you',textAlign: TextAlign.start,style: TextStyle(fontSize: 17,fontWeight: FontWeight.w500,color: Colors.black,)),
                      ),//Best for you
                    Container(
                      height: 250,
